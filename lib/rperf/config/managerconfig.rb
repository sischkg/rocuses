...
module RPerf
  module Config
    ...
    class ManagerConfig
      ...
      # <rperf><manager><options><NAME ATTR="VAR"/></options></manager></rperf>
      # のVARを取得する。
      # doc:: REXML::Document
      # name:: Elementの名前
      # attr:: 属性の名前
      ...
      def load_option( doc, name, attr, default_value )
        element = doc.elements["/rperf/manager/options/#{ name }"]
