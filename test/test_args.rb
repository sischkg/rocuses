...
class TestUtils < Test::Unit::TestCase
  ...
  must "required test ok" do
    ...
    assert_nothing_raised {
      Rocuses::Utils::check_args( args, { :arg1 => :req } )
    }
    assert_nothing_raised {
      Rocuses::Utils::check_args( args, { :arg1 => :required } )
    }
  end
  ...
  must "optional test ok" do
    args = { :arg2 => 'optional' }
    assert_nothing_raised {
      Rocuses::Utils::check_args( args, { :arg2 => :op } )
    }
    assert_nothing_raised {
      Rocuses::Utils::check_args( args, { :arg2 => :optional } )
    }
  end
  ...
  must "required and optional keys ok" do
    ...
    assert_nothing_raised {
      Rocuses::Utils::check_args( args, { :arg1 => :req, :arg2 => :op } )
    }
  end
  ...
  must "invalid key type error detected" do
    assert_raise( ArgumentError ) {
      Rocuses::Utils::check_args( { :arg0 => 'required' }, { :arg0 => :none } )
    }
  end

  must "valid keys" do
    assert_nothing_raised {
      Rocuses::Utils::check_args( { :arg0 => 'required' }, { :arg0 => :req, :arg1 => :optional } )
    }
  end

  must "raise ArgumentError if hash is nil" do
    assert_raise( ArgumentError ) {
      Rocuses::Utils::check_args( nil, { :arg0 => :req, :arg1 => :optional } )
    }
  end

  must "raise ArgumentError if keys is nil" do
    assert_raise( ArgumentError ) {
      Rocuses::Utils::check_args( { :arg0 => 'test' }, nil )
    }
  end
  ...
  must "fill default values" do
    ...
    new_args = Rocuses::Utils::fill_default_value( args, default_value_of )
  ...
  must "raise argument error, if args is nill" do
    assert_raise( ArgumentError ) {
      Rocuses::Utils::fill_default_value( nil, {} )
    }
  end
